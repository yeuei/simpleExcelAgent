...
def delete_sheet(filepath: str, sheet_name: str) -> Dict[str, Any]:
    ...
    If deletion fails because this is the only worksheet, either:
    1. Create a new worksheet first then delete this one
    2. Create and work on a new worksheet directly
    """
    try:
        wb = load_workbook(filepath)
